...
public class EditProfileFragment extends Fragment {
    ...
    public void getData(String idUser){
        ...
        try {
            ...
            for(int i = 0;i<jsonArr.length();i++){
                ...
                user = jsonObject.optString("usuario");
    ...
    class TaskUpdate extends AsyncTask<String,Void,String> {
        ...
        private String HttpUpdate(String myUrl) throws IOException, JSONException {
            ...
            setPutRequestContent(conn, jsonObject);
        ...
        private JSONObject buidJsonObject() throws JSONException {
            Log.d("llegue al buil", editName.getText().toString());
        ...
        private void setPutRequestContent(HttpURLConnection conn,
